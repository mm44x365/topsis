                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="card shadow">
                                ...
                                <div class="card-body">
                                    <form method="POST" action="<?= base_url('alternatif/proses_ubah/' . $alternatif->id) ?>">
                                        <div class="form-group">
                                            <label for="alternatif">Nama Alternatif</label>
                                            <input type="text" class="form-control" name="alternatif" id="alternatif" autocomplete="off" required="required" placeholder="ketik" value="<?= $alternatif->alternatif ?>">
                                        </div>
                                        <div class="form-group">
                                            <button type="submit" class="btn btn-sm btn-success" name="ubah"><i class="fa fa-pen"></i> Ubah</button>
                                            <button type="reset" class="btn btn-sm btn-danger"><i class="fa fa-times"></i> Batal</button>
                                            <a href="<?= base_url('alternatif') ?>" class="btn btn-sm btn-secondary"><i class="fa fa-reply"></i> Kembali</a>
                                        </div>
                                    </form>
                                </div>
                            </div>
