                                ...
                                <div class="card-body">
                                    <form method="POST" action="<?= base_url('alternatif/tambah') ?>">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="alternatif" id="alternatif" autocomplete="off" required="required" placeholder="ketik">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <tbody>
                                            <?php while ($alternatif = $data_alternatif->fetch_object()) : ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="<?= base_url('alternatif/ubah/' . $alternatif->id) ?>" class="btn btn-sm btn-info"><i class="fa fa-pen"></i> Ubah</a>
                                                        <a href="<?= base_url('alternatif/hapus/' . $alternatif->id) ?>" class="btn btn-sm btn-danger" onclick="return confirm('apakah anda yakin?')"><i class="fa fa-trash"></i> Hapus</a>
                                                    </td>
                                                </tr>
                                            <?php endwhile; ?>
                                        </tbody>
