                                ...
                                <div class="card-body">
                                    <form method="POST" action="<?= base_url('kriteria/tambah') ?>">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="kriteria" id="kriteria" autocomplete="off" required="required" placeholder="ketik">
                                        </div>
                                        <div class="form-group">
                                            <label for="bobot">Bobot</label>
                                            <input type="text" class="form-control" name="bobot" id="bobot" autocomplete="off" required="required" placeholder="ketik">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <tbody>
                                            <?php while ($kriteria = $data_kriteria->fetch_object()) : ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="<?= base_url('kriteria/ubah/' . $kriteria->id) ?>" class="btn btn-sm btn-info"><i class="fa fa-pen"></i> Ubah</a>
                                                        <a href="<?= base_url('kriteria/hapus/' . $kriteria->id) ?>" class="btn btn-sm btn-danger" onclick="return confirm('apakah anda yakin?')"><i class="fa fa-trash"></i> Hapus</a>
                                                    </td>
                                                </tr>
                                            <?php endwhile; ?>
                                        </tbody>
