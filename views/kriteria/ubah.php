                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="card shadow">
                                ...
                                <div class="card-body">
                                    <form method="POST" action="<?= base_url('kriteria/proses_ubah/' . $kriteria->id) ?>">
                                        <div class="form-group">
                                            <label for="kriteria">Nama Kriteria</label>
                                            <input type="text" class="form-control" name="kriteria" id="kriteria" autocomplete="off" required="required" placeholder="ketik" value="<?= $kriteria->kriteria ?>">
                                        </div>
                                        <div class="form-group">
                                            <label for="bobot">Bobot</label>
                                            <input type="text" class="form-control" name="bobot" id="bobot" autocomplete="off" required="required" placeholder="ketik" value="<?= $kriteria->bobot ?>">
                                        </div>
                                        <div class="form-group">
                                            <button type="submit" class="btn btn-sm btn-success" name="ubah"><i class="fa fa-pen"></i> Ubah</button>
                                            <button type="reset" class="btn btn-sm btn-danger"><i class="fa fa-times"></i> Batal</button>
                                            <a href="<?= base_url('kriteria') ?>" class="btn btn-sm btn-secondary"><i class="fa fa-reply"></i> Kembali</a>
                                        </div>
                                    </form>
                                </div>
                            </div>
