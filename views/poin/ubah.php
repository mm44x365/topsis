                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="card shadow">
                                ...
                                <div class="card-body">
                                    <form method="POST" action="<?= base_url('poin/proses_ubah/' . $poin->id) ?>">
                                        <div class="form-group">
                                            <label for="poin">Nama Poin</label>
                                            <input type="text" class="form-control" name="poin" id="poin" autocomplete="off" required="required" placeholder="ketik" value="<?= $poin->poin ?>">
                                        </div>
                                        <div class="form-group">
                                            <button type="submit" class="btn btn-sm btn-success" name="ubah"><i class="fa fa-pen"></i> Ubah</button>
                                            <button type="reset" class="btn btn-sm btn-danger"><i class="fa fa-times"></i> Batal</button>
                                            <a href="<?= base_url('poin') ?>" class="btn btn-sm btn-secondary"><i class="fa fa-reply"></i> Kembali</a>
                                        </div>
                                    </form>
                                </div>
                            </div>
