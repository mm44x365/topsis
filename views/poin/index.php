                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="card shadow">
                                ...
                                <div class="card-body">
                                    <form method="POST" action="<?= base_url('poin/tambah') ?>">
                                        <div class="form-group">
                                            <label for="poin">Nama Poin</label>
                                            <input type="text" class="form-control" name="poin" id="poin" autocomplete="off" required="required" placeholder="ketik">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <tbody>
                                            <?php while ($poin = $data_poin->fetch_object()) : ?>
                                                <tr>
                                                    ...
                                                    <td><?= $poin->poin ?></td>
                                                    <td>
                                                        <a href="<?= base_url('poin/ubah/' . $poin->id) ?>" class="btn btn-sm btn-info"><i class="fa fa-pen"></i> Ubah</a>
                                                        <a href="<?= base_url('poin/hapus/' . $poin->id) ?>" class="btn btn-sm btn-danger" onclick="return confirm('apakah anda yakin?')"><i class="fa fa-trash"></i> Hapus</a>
                                                    </td>
                                                </tr>
                                            <?php endwhile; ?>
                                        </tbody>
